 ...
 * @method Guthaben            setName()             Sets the current record's "name" value
 * @method Guthaben            setBeschreibung()     Sets the current record's "beschreibung" value
 * @method Guthaben            setKosten()           Sets the current record's "kosten" value
 * @method Guthaben            setZahlintervallId()  Sets the current record's "zahlintervall_id" value
 * @method Guthaben            setZahlintervall()    Sets the current record's "Zahlintervall" value
 * @method Guthaben            setArticles()         Sets the current record's "Articles" collection
 * 
 ...
 */
abstract class BaseGuthaben extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        $this->setTableName('guthaben');
