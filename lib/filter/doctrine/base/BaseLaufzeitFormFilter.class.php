...
/**
 * Laufzeit filter form base class.
 *
 ...
 */
abstract class BaseLaufzeitFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'laufzeit_in_monaten' => new sfWidgetFormFilterInput(array('with_empty' => false)),
    ...
    $this->setValidators(array(
      ...
      'laufzeit_in_monaten' => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
    ...
    $this->widgetSchema->setNameFormat('laufzeit_filters[%s]');
