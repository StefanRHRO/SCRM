...
/**
 * Portierung filter form base class.
 *
 ...
 */
abstract class BasePortierungFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('portierung_filters[%s]');
