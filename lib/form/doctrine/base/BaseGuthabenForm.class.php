...
/**
 * Guthaben form base class.
 *
 * @method Guthaben getObject() Returns the current form's model object
 *
 * @package    shopping_cart
 * @subpackage form
 * @author     Stefan Riedel
 * @version    SVN: $Id: BaseGuthabenForm.class.php 13 2011-07-29 06:30:00Z sriedel $
 */
abstract class BaseGuthabenForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('guthaben[%s]');
