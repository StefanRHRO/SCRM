...
/**
 * Portierung form base class.
 *
 * @method Portierung getObject() Returns the current form's model object
 *
 * @package    shopping_cart
 * @subpackage form
 * @author     Stefan Riedel
 * @version    SVN: $Id: BasePortierungForm.class.php 13 2011-07-29 06:30:00Z sriedel $
 */
abstract class BasePortierungForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('portierung[%s]');
